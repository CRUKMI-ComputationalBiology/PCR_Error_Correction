...
//struct eqstr {
//  bool operator()(const mpz_class& kmer_val_a, const mpz_class& kmer_val_b) const {
//        int cmp = mpz_cmp( kmer_val_a.get_mpz_t(), kmer_val_b.get_mpz_t() );
...
//typedef map<kmer_int_type_t,unsigned int, eqstr> Kmer_counter_map;
//typedef map<kmer_int_type_t,unsigned int, eqstr>::iterator Kmer_counter_map_iterator;
//typedef map<kmer_int_type_t,unsigned int, eqstr>::const_iterator Kmer_counter_map_const_iterator;
